...
var _forder_root = './data/04/';
var _forder_root_1 = './data/03/';
var target_folder = _forder_root + target_date;
var target_folder_csv = _forder_root_1 + target_date + "/csv/"; 
...
var FN01 = function( arr,fileNm ){
	...
	var agencyInfo = fs.readFileSync( "d:/dev/krx_stock_info/data/agency/" + target_date + "/json/" + target_date + ".json" ).toString()
	...
	var siseInfo = fs.readFileSync( "d:/dev/krx_stock_info/data/sise/" + target_date + "/json/" + target_date + ".json" ).toString()

...
var JSONtoDb = function( target_date ){

	console.log( "[ S ] - " + Date.now() );
	
	var _tdbjs_nm = "07_update_mass_trns_DATA_RANK";	

	
	var _tQuery = fs.readFileSync( _tDbjs_PATH + "/" + _tdbjs_nm + ".tdbjs" ).toString();
	//var data = fs.readFileSync( filePath ).toString();
	
	var query = _tQuery.replace( /<!=DATE=!>/gi, target_date );

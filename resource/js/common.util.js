...
window.COMPONENT.renderMarketIndexGlobal = function( option ){
	...
	for( s in window.socketData.MarketIndexGlobal ){
		...
		if( typeof option != "undefined" && option.length != 0 ) if( option.indexOf( s ) == -1 ) continue
...
window.COMPONENT.renderExchangeIndex = function(){
	...
	for(;i<iLen;++i){
		...
		var _html00 = `<div class="card" style="margin:0px 0px 10px 0px;padding: 5px!important;box-shadow: 0 1px 1px 0 #ccc, 0 0 0 1px #ccc !important;border-radius: 0rem !important;display:block;cursor:pointer;" id="exchange_index_${io.reutersCode}" data-cd-value="${io.reutersCode}" data-nm-value="${io.reutersCode}">`
		var _html01 =`
			<div style="background-color: #97979747;position: absolute;width: 100%;height: 100%;z-index: 5;top: 0px;left: 0;display:${display};"></div>
			<div class="">
...
window.COMPONENT.renderEnergyIndex = function(){
	...
	for(;i<iLen;++i){
		...
		var _html00 = `<div class="card" style="margin:0px 0px 10px 0px;padding: 5px!important;box-shadow: 0 1px 1px 0 #ccc, 0 0 0 1px #ccc !important;border-radius: 0rem !important;display:block;cursor:pointer;" id="energy_index_${io.reutersCode}" data-cd-value="${io.reutersCode}" data-nm-value="${io.reutersCode}">`
		var _html01 =`
			<div style="background-color: #97979747;position: absolute;width: 100%;height: 100%;z-index: 5;top: 0px;left: 0;display:${display};"></div>
			<div class="">
				<span style="font-size:13px;"> ${name}</span>${marketStatus}
...
window.COMPONENT.renderAgriculturalIndex = function(){
	...
	for(;i<iLen;++i){
		...
		var _html00 = `<div class="card" style="margin:0px 0px 10px 0px;padding: 5px!important;box-shadow: 0 1px 1px 0 #ccc, 0 0 0 1px #ccc !important;border-radius: 0rem !important;display:block;cursor:pointer;" id="agricultural_index_${io.reutersCode}" data-cd-value="${io.reutersCode}" data-nm-value="${io.reutersCode}">`
		var _html01 =`
			<div style="background-color: #97979747;position: absolute;width: 100%;height: 100%;z-index: 5;top: 0px;left: 0;display:${display};"></div>
			<div class="">
				<span style="font-size:13px;"> ${name}</span>${marketStatus}
